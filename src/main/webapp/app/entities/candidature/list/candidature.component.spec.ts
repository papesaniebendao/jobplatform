...
import { sampleWithRequiredData } from '../candidature.test-samples';
...
describe('Candidature Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.candidatures()[0]).toEqual(expect.objectContaining({ id: 17844 }));
  });

  describe('trackId', () => {
    it('should forward to candidatureService', () => {
      const entity = { id: 17844 };
      jest.spyOn(service, 'getCandidatureIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCandidatureIdentifier).toHaveBeenCalledWith(entity);
