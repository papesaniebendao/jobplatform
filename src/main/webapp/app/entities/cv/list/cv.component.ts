...
import { CVService, EntityArrayResponseType } from '../service/cv.service';
...
export class CVComponent implements OnInit {
  ...
  trackId = (item: ICV): number => this.cVService.getCVIdentifier(item);
      ...
      .pipe(
        ...
        tap(() => {
          if (this.cVS().length === 0) {
            ...
            this.cVS.set(this.refineData(this.cVS()));
          }
        }),
      )
      .subscribe();
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.cVS.set(this.refineData(dataFromBody));
  }

  protected refineData(data: ICV[]): ICV[] {
