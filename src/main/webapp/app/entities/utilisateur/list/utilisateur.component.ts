...
export class UtilisateurComponent implements OnInit {
      ...
      .pipe(
        ...
        tap(() => {
          if (this.utilisateurs().length === 0) {
            ...
            this.utilisateurs.set(this.refineData(this.utilisateurs()));
          }
        }),
      )
      .subscribe();
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.utilisateurs.set(this.refineData(dataFromBody));
  }

  protected refineData(data: IUtilisateur[]): IUtilisateur[] {
